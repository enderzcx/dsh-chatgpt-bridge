...
export const BRIDGE_ERROR_CODES: readonly string[] = [
  'APPROVAL_NOT_FOUND',
...
export const DIRECT_OPS_ERROR_CODES: readonly string[] = [
...
export const CODEX_CLIENT_ERROR_CODES: readonly string[] = [
  'CODEX_INIT_FAILED',
];

/** Codes the MCP layer itself produces for a call it refused to dispatch. */
export const MCP_SURFACE_ERROR_CODES: readonly string[] = [
  'INVALID_ARGUMENTS',
  'UNKNOWN',
  'INTERNAL',
];
...
export function isKnownErrorCode(value: unknown): value is string {
